 ...
 * @method \Cake\Datasource\ResultSetInterface<int, \Sandbox\Model\Entity\SandboxArticle> paginate(\Cake\Datasource\RepositoryInterface|\Cake\Datasource\QueryInterface|string|null $object = null, array<string, mixed> $settings = [])
 */
