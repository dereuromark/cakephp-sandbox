 ...
 * @method iterable<\Sandbox\Model\Entity\BitmaskedRecord>|false saveMany(iterable $entities, $options = [])
 * @method iterable<\Sandbox\Model\Entity\BitmaskedRecord> saveManyOrFail(iterable $entities, $options = [])
 * @method iterable<\Sandbox\Model\Entity\BitmaskedRecord>|false deleteMany(iterable $entities, $options = [])
 * @method iterable<\Sandbox\Model\Entity\BitmaskedRecord> deleteManyOrFail(iterable $entities, $options = [])
 *
