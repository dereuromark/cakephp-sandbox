 ...
 * @method \Sandbox\Model\Entity\SandboxUser get(mixed $primaryKey, string $finder = 'all', \Psr\SimpleCache\CacheInterface|string|null $cache = null, \Closure|string|null $cacheKey = null, mixed ...$args)
 * @method \Sandbox\Model\Entity\SandboxUser findOrCreate($search, ?callable $callback = null, array $options = [])
