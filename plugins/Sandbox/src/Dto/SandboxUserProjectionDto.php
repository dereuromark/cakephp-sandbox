...
/**
 * SandboxUserProjection DTO
 *
 * @property int|null $id
 * @property string|null $username
 * @property string|null $email
 * @property \Sandbox\Model\Enum\UserStatus|null $status
 * @property \Cake\I18n\DateTime|null $created
 */
class SandboxUserProjectionDto extends AbstractImmutableDto {
	...
	protected array $_metadata = [
		...
		'status' => [
			'name' => 'status',
			'type' => '\Sandbox\Model\Enum\UserStatus',
			'required' => false,
			'defaultValue' => null,
			'dto' => null,
			'collectionType' => null,
	...
	/**
	 * @param \Sandbox\Model\Enum\UserStatus|null $status
	 *
	 * @return static
	 */
	...
	/**
	 * @param \Sandbox\Model\Enum\UserStatus $status
	 *
	 * @return static
	 */
	...
	/**
	 * @return \Sandbox\Model\Enum\UserStatus|null
	 */
	public function getStatus(): ?\Sandbox\Model\Enum\UserStatus {
		return $this->status;
	}
	 ...
	 * @throws \RuntimeException If value is not set.
	 *
	 * @return \Sandbox\Model\Enum\UserStatus
	 */
	public function getStatusOrFail(): \Sandbox\Model\Enum\UserStatus {
		if ($this->status === null) {
	 ...
	 * @param bool $touched
	 *
	 * @return array{id: int|null, username: string|null, email: string|null, status: \Sandbox\Model\Enum\UserStatus|null, created: \Cake\I18n\DateTime|null}
	 */
	public function toArray(?string $type = null, ?array $fields = null, bool $touched = false): array {
		/** @var array{id: int|null, username: string|null, email: string|null, status: \Sandbox\Model\Enum\UserStatus|null, created: \Cake\I18n\DateTime|null} $result */
	...
	/**
	 * @param array{id: int|null, username: string|null, email: string|null, status: \Sandbox\Model\Enum\UserStatus|null, created: \Cake\I18n\DateTime|null} $data
