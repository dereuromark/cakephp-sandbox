 ...
 * @method \StateMachineSandbox\Model\Entity\Registration get(mixed $primaryKey, string $finder = 'all', \Psr\SimpleCache\CacheInterface|string|null $cache = null, \Closure|string|null $cacheKey = null, mixed ...$args)
 * @method \StateMachineSandbox\Model\Entity\Registration findOrCreate($search, ?callable $callback = null, array $options = [])
