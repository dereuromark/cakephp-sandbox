...
I give no safety quaranties or whatsoever on it. You use it on your own risk.<br /><br />
...
<h2><?php echo __('Impressum') ?></h2>
<p>
<b>Mark Scherer</b> (Site-Owner)<br />
<?php echo $this->Format->encodeEmail('markscherer@gmx.de');?>
</p>

<h2>Disclaimer</h2>
<p>
<b>CONTENT PROVIDED VIA LINKS</b>
<br />
