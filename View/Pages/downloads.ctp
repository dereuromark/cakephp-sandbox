...
<ul>
<li><?php echo $this->Html->link('Download page', 'http://github.com/cakephp/cakephp/downloads', array('target' => '_blank'));?></li>
</ul>

<h2>CakePHP-Core: Git Checkout</h2>
Even nicer because you need just one click to get the current HEAD (current version).

<ul>
<li><?php echo $this->Html->link('Browse the online rep.', 'http://github.com/cakephp/cakephp', array('target' => '_blank'));?></li>
</ul>
<br />
