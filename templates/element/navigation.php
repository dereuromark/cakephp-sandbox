		...
		<ul class="navbar-nav bd-navbar-nav flex-row">
			...
			<li class="nav-item dropdown">
				...
				<ul class="dropdown-menu" aria-labelledby="sandbox">
					...
					<li class="nav-item"><?php echo $this->Html->linkReset('Menu Sandbox', ['plugin' => 'MenuSandbox', 'admin' => false, 'controller' => 'MenuSandbox', 'action' => 'index'], ['class' => 'nav-link', 'tabindex' => '-1']); ?></li>
					<li class="dropdown-divider"></li>
