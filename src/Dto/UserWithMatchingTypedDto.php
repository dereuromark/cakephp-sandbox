...
class UserWithMatchingTypedDto extends AbstractImmutableDto {
	 ...
	 */
	protected ?\App\Dto\MatchingDataDto $_matchingData = null;
	 ...
	 * @return static
	 */
	public function withMatchingData(?\App\Dto\MatchingDataDto $_matchingData = null): static {
		$new = clone $this;
	 ...
	 * @return static
	 */
	public function withMatchingDataOrFail(\App\Dto\MatchingDataDto $_matchingData): static {
		$new = clone $this;
		$new->_matchingData = $_matchingData;
		$new->_touchedFields[static::FIELD_MATCHING_DATA] = true;
