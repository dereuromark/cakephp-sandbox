...
/**
 * UserWithMatching DTO
 *
 * @property int|null $id
 * @property string|null $username
 * @property string|null $email
 * @property \Cake\I18n\DateTime|null $created
 * @property array|null $_matchingData
 */
class UserWithMatchingDto extends AbstractImmutableDto {
	 ...
	 * @var array|null
	 */
	protected ?array $_matchingData = null;
	...
	*/
	...
	protected function setFromArrayFast(array $data): void {
		...
		if (isset($data['_matchingData'])) {
			$this->_matchingData = $data['_matchingData'];
	...
	protected function toArrayFast(): array {
		return [
			...
			'_matchingData' => $this->_matchingData,
		];
	}
	...
	/**
	 * @param array|null $_matchingData
	 *
	 * @return static
	 */
	public function withMatchingData(?array $_matchingData = null): static {
		$new = clone $this;
	...
	/**
	 * @param array $_matchingData
	 *
	 * @return static
	 */
	public function withMatchingDataOrFail(array $_matchingData): static {
		$new = clone $this;
		$new->_matchingData = $_matchingData;
		$new->_touchedFields[static::FIELD_MATCHING_DATA] = true;
	 ...
	 * @param bool $touched
	 *
	 * @return array{id: int|null, username: string|null, email: string|null, created: \Cake\I18n\DateTime|null, _matchingData: array<int, mixed>|null}
	 */
	public function toArray(?string $type = null, ?array $fields = null, bool $touched = false): array {
		/** @var array{id: int|null, username: string|null, email: string|null, created: \Cake\I18n\DateTime|null, _matchingData: array<int, mixed>|null} $result */
	...
	/**
	 * @param array{id: int|null, username: string|null, email: string|null, created: \Cake\I18n\DateTime|null, _matchingData: array<int, mixed>|null} $data
