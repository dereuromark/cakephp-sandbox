...
class UserProjectionDto extends AbstractImmutableDto {
	 ...
	 */
	protected ?\App\Dto\RoleProjectionDto $role = null;
	 ...
	 * @return static
	 */
	public function withRole(?\App\Dto\RoleProjectionDto $role = null): static {
		$new = clone $this;
		$new->role = $role;
	 ...
	 * @return static
	 */
	public function withRoleOrFail(\App\Dto\RoleProjectionDto $role): static {
		$new = clone $this;
		$new->role = $role;
		$new->_touchedFields[static::FIELD_ROLE] = true;
