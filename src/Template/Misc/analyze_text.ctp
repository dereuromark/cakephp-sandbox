...
<?php echo $this->Form->create();?>
	...
	<?php
		echo $this->Form->control('Form.text', ['type' => 'textarea', 'class' => 'halfSize', 'rows' => 15]);
		//echo $this->Form->control('Form.type', array('empty'=>array('0'=>'- [auto-detect] -')));
		echo $this->Form->control('Form.min_char', []);
		echo $this->Form->control('Form.max_char', []);
		echo $this->Form->control('Form.sort', ['options' => ['' => '- [none] -', 'asc' => 'ASC', 'desc' => 'DESC']]);
		echo $this->Form->control('Form.limit');

		//echo $this->Form->control('Form.prevent_trim', array('type'=>'hidden', 'value'=>1));
	?>
	</fieldset>
